...
../libs/gnl/get_next_line.c ../libs/math/*.c ../libs/gnl/get_next_line_utils.c ../libs/gnl/get_next_line.h \
 -I ../assets/minilibx-linux/ -I ../libs/math/  -L ../assets/minilibx-linux/ -lm -lmlx -lXext -lX11 -o minirt"
